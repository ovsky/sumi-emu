...
import org.sumi.sumi_emu.databinding.FragmentSearchBinding
import org.sumi.sumi_emu.layout.AutofitGridLayoutManager
...
class SearchFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        preferences = PreferenceManager.getDefaultSharedPreferences(SumiApplication.appContext)
