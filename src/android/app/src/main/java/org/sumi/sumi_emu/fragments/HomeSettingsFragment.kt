...
import org.sumi.sumi_emu.BuildConfig
...
import org.sumi.sumi_emu.adapters.HomeSettingAdapter
import org.sumi.sumi_emu.databinding.FragmentHomeSettingsBinding
import org.sumi.sumi_emu.features.DocumentProvider
...
import org.sumi.sumi_emu.utils.ViewUtils.updateMargins
...
class HomeSettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val optionsList: MutableList<HomeSetting> = mutableListOf<HomeSetting>().apply {
            ...
            add(
                HomeSetting(
                    R.string.manage_sumi_data,
                    R.string.manage_sumi_data_description,
                    ...
                    R.drawable.ic_check_circle,
                    {
                        ProgressDialogFragment.newInstance(
                            ...
                            return@newInstance if (progressCallback.invoke(100, 100)) {
                                ...
                                val errorMessage = SumiApplication.appContext.getString(
    ...
    private fun shareLog() {
        val currentLog = DocumentFile.fromSingleUri(
            ...
            DocumentsContract.buildDocumentUri(
                ...
                "${DocumentProvider.ROOT_ID}/log/sumi_log.txt"
            )
        )!!
        val oldLog = DocumentFile.fromSingleUri(
            ...
            DocumentsContract.buildDocumentUri(
                DocumentProvider.AUTHORITY,
                "${DocumentProvider.ROOT_ID}/log/sumi_log.txt.old.txt"
            )
        )!!
