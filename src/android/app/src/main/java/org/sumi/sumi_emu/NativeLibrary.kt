    ...
    // SPDX-FileCopyrightText: Copyright sumi/Citra Emulator Project / Eden Emulator Project
    ...
    import org.sumi.sumi_emu.fragments.CoreErrorDialogFragment
    import org.sumi.sumi_emu.utils.DocumentsTree
    import org.sumi.sumi_emu.utils.FileUtil
    import org.sumi.sumi_emu.utils.Log
    import org.sumi.sumi_emu.model.InstallResult
    import org.sumi.sumi_emu.model.Patch
    import org.sumi.sumi_emu.model.GameVerificationResult
    import org.sumi.sumi_emu.network.NetPlayManager
    ...
    object NativeLibrary {
        ...
        init {
            try {
                System.loadLibrary("sumi-android")
        ...
        fun openContentUri(path: String?, openmode: String?): Int {
            return if (DocumentsTree.isNativePath(path!!)) {
                SumiApplication.documentsTree!!.openContentUri(path, openmode)
            } else {
        ...
        fun getSize(path: String?): Long {
            return if (DocumentsTree.isNativePath(path!!)) {
                SumiApplication.documentsTree!!.getFileSize(path)
            } else {
        ...
        fun exists(path: String?): Boolean {
            return if (DocumentsTree.isNativePath(path!!)) {
                SumiApplication.documentsTree!!.exists(path)
            } else {
        ...
        fun isDirectory(path: String?): Boolean {
            return if (DocumentsTree.isNativePath(path!!)) {
                SumiApplication.documentsTree!!.isDirectory(path)
            } else {
        ...
        fun getParentDirectory(path: String): String =
            if (DocumentsTree.isNativePath(path)) {
                SumiApplication.documentsTree!!.getParentDirectory(path)
            } else {
                path
            }
        ...
        fun getFilename(path: String): String =
            if (DocumentsTree.isNativePath(path)) {
                SumiApplication.documentsTree!!.getFilename(path)
            } else {
