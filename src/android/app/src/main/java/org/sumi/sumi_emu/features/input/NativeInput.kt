...
import org.sumi.sumi_emu.features.input.model.ButtonName
...
object NativeInput {
     ...
     * @param device An [InputDevice] or the input overlay wrapped with [SumiInputDevice]
     */
    external fun registerController(device: SumiInputDevice)
