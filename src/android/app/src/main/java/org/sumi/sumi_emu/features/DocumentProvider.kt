...
package org.sumi.sumi_emu.features
...
import org.sumi.sumi_emu.getPublicFilesDir

class DocumentProvider : DocumentsProvider() {
    private val baseDirectory: File
        get() = File(SumiApplication.application.getPublicFilesDir().canonicalPath)
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        cursor.newRow().apply {
            ...
            add(DocumentsContract.Root.COLUMN_ICON, R.drawable.ic_sumi)
        }
