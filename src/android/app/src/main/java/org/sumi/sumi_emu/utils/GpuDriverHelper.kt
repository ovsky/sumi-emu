...
object GpuDriverHelper {
    ...
    fun initializeDriverParameters() {
        try {
            ...
            fileRedirectionPath = SumiApplication.appContext
                .getExternalFilesDir(null)!!.canonicalPath + "/gpu/vk_file_redirect/"

            // Initialize the driver installation directory.
            driverInstallationPath = SumiApplication.appContext
        ...
        hookLibPath = SumiApplication.appContext.applicationInfo.nativeLibraryDir + "/"
