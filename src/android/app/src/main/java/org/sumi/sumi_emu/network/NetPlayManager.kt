...
package org.sumi.sumi_emu.network
...
import org.sumi.sumi_emu.dialogs.ChatMessage
...
object NetPlayManager {
    ...
    fun getUsername(activity: Context): String {        val prefs = PreferenceManager.getDefaultSharedPreferences(activity)
        val name = "Sumi${(Math.random() * 100).toInt()}"
    ...
    fun addNetPlayMessage(type: Int, msg: String) {
        val context = SumiApplication.appContext
