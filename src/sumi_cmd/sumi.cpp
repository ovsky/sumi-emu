...
#include "sumi_cmd/emu_window/emu_window_sdl2_gl.h"
#include "sumi_cmd/emu_window/emu_window_sdl2_null.h"
#include "sumi_cmd/emu_window/emu_window_sdl2_vk.h"
...
static void PrintVersion() {
    std::cout << "sumi " << Common::g_scm_branch << " " << Common::g_scm_desc << std::endl;
}
    ...
    default:
        if (static_cast<u32>(load_result) >
            ...
            LOG_CRITICAL(Frontend,
                         ...
                         "refer to the sumi wiki for more information or the sumi discord for "
                         "additional help.\n\nError Code: {:04X}-{:04X}\nError Description: {}",
