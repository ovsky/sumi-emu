...
private:
    /**
     * Handles button presses to execute functions assigned in sumi_key_callbacks.
     * sumi_key_callbacks contains specialized functions for the buttons in the window footer
     * that can be overridden by games to achieve desired functionality.
     *
     * @tparam HIDButton The list of buttons contained in sumi_key_callbacks
     */
