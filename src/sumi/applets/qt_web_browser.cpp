...
#include "sumi/applets/qt_web_browser_scripts.h"
#endif

#include "common/fs/path_util.h"
#include "core/core.h"
#include "input_common/drivers/keyboard.h"
#include "sumi/applets/qt_web_browser.h"
#include "sumi/main.h"
#include "sumi/util/url_request_interceptor.h"
...
QtNXWebEngineView::QtNXWebEngineView(QWidget* parent, Core::System& system,
    ...
    default_profile->setPersistentStoragePath(QString::fromStdString(Common::FS::PathToUTF8String(
        Common::FS::GetSumiPath(Common::FS::SumiPath::SumiDir) / "qtwebengine")));
...
void QtNXWebEngineView::HandleWindowFooterButtonPressedOnce() {
    const auto f = [this](Core::HID::NpadButton button) {
        if (input_interpreter->IsButtonPressedOnce(button)) {
            ...
            page()->runJavaScript(
                QStringLiteral("sumi_key_callbacks[%1] == null;").arg(button_index),
            ...
            page()->runJavaScript(
                QStringLiteral("if (sumi_key_callbacks[%1] != null) { sumi_key_callbacks[%1](); }")
                    .arg(button_index));
        }
    };
...
void QtNXWebEngineView::LoadExtractedFonts() {
    ...
    auto fonts_dir_str = Common::FS::PathToUTF8String(
        Common::FS::GetSumiPath(Common::FS::SumiPath::CacheDir) / "fonts/");
