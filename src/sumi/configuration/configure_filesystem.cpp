...
#include "sumi/configuration/configure_filesystem.h"
...
void ConfigureFilesystem::SetConfiguration() {
    ui->nand_directory_edit->setText(
        QString::fromStdString(Common::FS::GetSumiPathString(Common::FS::SumiPath::NANDDir)));
    ui->sdmc_directory_edit->setText(
        QString::fromStdString(Common::FS::GetSumiPathString(Common::FS::SumiPath::SDMCDir)));
    ui->gamecard_path_edit->setText(
        QString::fromStdString(Settings::values.gamecard_path.GetValue()));
    ui->dump_path_edit->setText(
        QString::fromStdString(Common::FS::GetSumiPathString(Common::FS::SumiPath::DumpDir)));
    ui->load_path_edit->setText(
        QString::fromStdString(Common::FS::GetSumiPathString(Common::FS::SumiPath::LoadDir)));
...
void ConfigureFilesystem::ApplyConfiguration() {
    Common::FS::SetSumiPath(Common::FS::SumiPath::NANDDir,
                            ui->nand_directory_edit->text().toStdString());
    Common::FS::SetSumiPath(Common::FS::SumiPath::SDMCDir,
                            ui->sdmc_directory_edit->text().toStdString());
    Common::FS::SetSumiPath(Common::FS::SumiPath::DumpDir,
                            ui->dump_path_edit->text().toStdString());
    Common::FS::SetSumiPath(Common::FS::SumiPath::LoadDir,
...
void ConfigureFilesystem::ResetMetadata() {
    if (!Common::FS::Exists(Common::FS::GetSumiPath(Common::FS::SumiPath::CacheDir) /
                            "game_list/")) {
