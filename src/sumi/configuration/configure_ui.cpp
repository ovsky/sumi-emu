...
#include "sumi/configuration/configure_ui.h"
    ...
    connect(ui->screenshot_path_button, &QToolButton::pressed, this, [this] {
        auto dir =
            QFileDialog::getExistingDirectory(this, tr("Select Screenshots Path..."),
                                              QString::fromStdString(Common::FS::GetSumiPathString(
                                                  Common::FS::SumiPath::ScreenshotsDir)));
        if (!dir.isEmpty()) {
...
void ConfigureUi::ApplyConfiguration() {
    ...
    Common::FS::SetSumiPath(Common::FS::SumiPath::ScreenshotsDir,
...
void ConfigureUi::SetConfiguration() {
    ...
    ui->screenshot_path_edit->setText(QString::fromStdString(
        Common::FS::GetSumiPathString(Common::FS::SumiPath::ScreenshotsDir)));
