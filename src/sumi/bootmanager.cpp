...
#if (QT_VERSION < QT_VERSION_CHECK(6, 0, 0)) && SUMI_USE_QT_MULTIMEDIA
#include <QCamera>
...
GRenderWindow::GRenderWindow(GMainWindow* parent, EmuThread* emu_thread_,
    ...
    setWindowTitle(QStringLiteral("sumi %1 | %2-%3")
...
#else
    QMessageBox::warning(this, tr("OpenGL not available!"),
                         tr("sumi has not been compiled with OpenGL support."));
    return false;
#endif
}
