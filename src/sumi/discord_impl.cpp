...
// The number is the client ID for sumi, it's used for images and the
// application name
...
const std::string default_text = "Sumi Is A Homebrew Emulator For The Nintendo Switch";
const std::string default_image = "sumi_logo";
