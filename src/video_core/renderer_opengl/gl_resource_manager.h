...
public:
    SUMI_NON_COPYABLE(OGLRenderbuffer);
...
public:
    SUMI_NON_COPYABLE(OGLTextureView);
...
public:
    SUMI_NON_COPYABLE(OGLAssemblyProgram);
...
public:
    SUMI_NON_COPYABLE(OGLFramebuffer);
...
public:
    SUMI_NON_COPYABLE(OGLTransformFeedback);
