...
function(copy_sumi_Qt5_deps target_dir)
    ...
    if (MSVC)
        ...
        windows_copy_files(sumi ${Qt5_PLATFORMS_DIR} ${PLATFORMS} qwindows$<$<CONFIG:Debug>:d>.*)
        windows_copy_files(sumi ${Qt5_STYLES_DIR} ${STYLES} qwindowsvistastyle$<$<CONFIG:Debug>:d>.*)
        windows_copy_files(sumi ${Qt5_IMAGEFORMATS_DIR} ${IMAGEFORMATS}
            qjpeg$<$<CONFIG:Debug>:d>.*
            qgif$<$<CONFIG:Debug>:d>.*
        )
        windows_copy_files(sumi ${Qt5_MEDIASERVICE_DIR} ${MEDIASERVICE}
...
endfunction(copy_sumi_Qt5_deps)
